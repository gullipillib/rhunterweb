...
<body style="background-color:black;">
    <form id="form1" runat="server">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT * FROM loggedusers" UpdateCommand="UPDATE loggedusers SET luloggedin='yes', lucrisboos='0'"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT * FROM appuserdetails" UpdateCommand="UPDATE appuserdetails SET tempgoldcoins=''" ></asp:SqlDataSource>
