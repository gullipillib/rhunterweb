...
<script runat="server">
    ...
    protected void checkusername()
    {
        ...
        if (Hiddenfield1 != null)
        {
            ...
            SqlDataSource5.SelectCommand = "SELECT uname FROM appuserdetails WHERE (uname = '" + Hiddenfield1 + "')";
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlDataSource1.SelectCommand = "Select * from toolbox where tbcompleted = 'no'  and tbnew = 'yes' and tbowner = '" + Hiddenfield1 + "' order by tborder ASC";
    ...
    protected void TextBox1_TextChanged(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectCommand = "SELECT toolbox.* FROM toolbox where tbname='" + TextBox1.Text + "'";
...
<body>
 ...
 <asp:Label ID="Label16" runat="server" style="z-index: 1; left: 719px; top: 268px; position: absolute; height: 49px; width: 271px" Text="Upload Images to OneDrive or Google Drive or Amazon S3 its Free!"></asp:Label>
       ...
       <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT categoryname FROM category"></asp:SqlDataSource>
        ...
        <asp:Button ID="Button5" runat="server" Enabled="False" style="z-index: 1; left: 681px; top: 55px; position: absolute; cursor:pointer" Text="Back to Game " OnClick="Button5_Click" BackColor="Blue" ForeColor="White" PostBackUrl="index1.aspx" />
       <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT subcategoryname FROM subcategory"></asp:SqlDataSource>  
       
       <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT othersname FROM others"></asp:SqlDataSource>
       ...
       <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT crname FROM collisionresult"></asp:SqlDataSource>
       
       <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT cescname FROM collisionescape"></asp:SqlDataSource>
...
<asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 234px; top: 337px; position: absolute; width: 383px; height: 29px" ToolTip="only png and gif file with transparent background, 100 x 120 and 30kb size only" ClientIDMode="Static" OnTextChanged="TextBox3_TextChanged" AutoPostBack="True" ReadOnly="False"></asp:TextBox>
 <asp:TextBox ID="TextBox4" runat="server" style="z-index: 1; left: 229px; top: 411px; position: absolute; width: 382px; height: 28px" ToolTip="only png and gif file with transparent background, 100 x 120 and 30kb size only" ClientIDMode="Static" OnTextChanged="TextBox4_TextChanged" AutoPostBack="True" ReadOnly="False"></asp:TextBox>
        ...
        <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="SqlDataSource6" DataTextField="crname" DataValueField="crname" style="z-index: 1; left: 215px; top: 562px; position: absolute; height: 33px; width: 311px; right: 374px" AutoPostBack="True">
        </asp:DropDownList>
        <asp:DropDownList ID="DropDownList5" runat="server" DataSourceID="SqlDataSource7" DataTextField="cescname" DataValueField="cescname" style="z-index: 1; left: 224px; top: 516px; position: absolute; height: 30px; width: 309px" AutoPostBack="True">
        </asp:DropDownList>
    ...
    <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="Red" NavigateUrl="http://eng.universal-soundbank.com" style="z-index: 1; left: 222px; top: 486px; position: absolute" Target="_blank">Sound Files link, copy only the url path do not download</asp:HyperLink>
       ...
       <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT uname FROM appuserdetails WHERE (uname = 'GullipilliBhaskar')"></asp:SqlDataSource>
