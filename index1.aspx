...
<script runat="server">
    ...
    {
        Session["loggeduser"] = "gullipilli vijay bhaskar";
        Hiddenfield1 = "gullipilli vijay bhaskar";
        //Hiddenfield1 = Session["loggeduser"].ToString;
        ...
        if (Hiddenfield1 != null)
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                if (dt.Rows.Count == 0)
                {
                    SqlDataSource4.InsertCommand = "INSERT INTO loggedusers(luname, luid, luposition, luimg, luspriteimg, lucrisboos, luloggedin, lutspots, lulogintimes, luinvites) VALUES ('" + Hiddenfield1 + "', '" + Hiddenfield1 + "', '{left : 0, top:0}', '" + Session["loggeduserurl"] + "', '" + Session["loggeduserurl"] + "', '100', 'no', '0', '0', '0')";
                ...
                Session["loggeduser"] = Hiddenfield1;
                Hiddenfield1 = Hiddenfield1.Replace(" ", "");
                Session["reached"] = "yes";

                SqlDataSource6.SelectCommand = "select paid from appuserdetails where uname = '" + Hiddenfield1 + "'";
                    ...
                    if (showshower == 1) {
                        ...
                        if (won == 1) {
                            ...
                            else if (parseInt(levels1,10) >= 200 && parseInt(levels1,10) < 400 && won == 1)
                            {
                                ...
                                {
                                    if (parseInt(document.getElementById('TextBox16').getAttribute("value"),10) >= 7 && parseInt

(document.getElementById('TextBox13').getAttribute("value"),10) >= 70)
                                    {
                                        levels1 = parseInt(levels1,10) + 1;
                                        document.getElementById('TextBox16').setAttribute("value", "0");
                                    ...
                                    document.getElementById('TextBox12').setAttribute("value", levels1);
                                    document.getElementById("TextBox17").setAttribute("value", parseInt

(document.getElementById('TextBox17').getAttribute("value"),10) + parseInt(document.getElementById

('points').getAttribute("value"),10));
                                    won = 0;
                                }
                            }
                            else if (parseInt(levels1,10) >= 400 && parseInt(levels1,10) < 1000 && won == 1)
                            {
                                document.getElementById("TextBox17").setAttribute("value", document.getElementById

('TextBox17').getAttribute("value"));
                                if (parseInt(document.getElementById('TextBox13').getAttribute("value"),10) > 100)
                                {
                                    if (parseInt(document.getElementById('TextBox16').getAttribute("value"),10) >= 8 && parseInt

(document.getElementById('TextBox13').getAttribute("value"),10) >= 100)
                                    {
                                        levels1 = parseInt(levels1,10) + 1;
                                        document.getElementById('TextBox16').setAttribute("value", "0");
...
('TextBox17').getAttribute("value"));
                            ...
                            //if (parseInt(levels1,10) <= 30 && wait != "yes" && upaid != "yes" && parseInt

                            (document.getElementById('TextBox14').getAttribute("value"),10) == 3 && parseInt('<%=tspotsowned%>',10) == 0 

                            || parseInt(levels1,10) > 75 && wait != "yes" && upaid != "yes" || parseInt(levels1,10) > 200 && wait != "yes" && 

                            upaid != "yes" || parseInt(levels1,10) > 400 && wait != "yes" && upaid != "yes") {
                                //levels1 = parseInt(levels1,10) + 1;
                                //document.getElementById('TextBox12').setAttribute("value", levels1);
                                //}
                            ...
                            showendresult = 1;
                            won = 0;
                            window.location.href = "/updatecoins.aspx?coins=" + document.getElementById

    ("points").getAttribute("value") + "&levels=" + levels1 + "&tscollected=" + document.getElementById

    ("TextBox16").getAttribute("value");
                            ...
                            document.getElementById("points").getAttribute("value") + "&levels=" + document.getElementById

                            ("TextBox12").getAttribute("value") + "&tscollected=" + document.getElementById("TextBox12").getAttribute
            ...
            function hitmeonce() {
                ...
                function removeexplosion() {
                    ...
                    if (lifes == 0) {
                        ...
                        document.getElementById('TextBox7').setAttribute("value", "So Sad You Lost All Your Lifes. The Gold 

Coins You Collected Now are Also Lost!! ");
                        var myaddctrl = window.setTimeout(function () { hidelabel() }, 4000);
                    }
                    function hidelabel() {
                        document.getElementById('TextBox7').style.visibility = "hidden";
            ...
            function detectcollision() {
                ...
                if (myctrl1.tbPropType == "movable") {
                    if (ctrl1.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(ctrl1.style.left.replace("px", ""), 10) && 

parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(ctrl1.style.right.replace("px", ""), 10) || parseInt

(crosshair.style.top.replace("px", ""), 10) >= parseInt(ctrl1.style.top.replace("px", ""), 10) && parseInt

(crosshair.style.bottom.replace("px", ""), 10) <= parseInt(ctrl1.style.bottom.replace("px", ""), 10)) {
                            ...
                            if (enemyhits == 10) {
                                ...
                                document.getElementById('TextBox4').setAttribute("value", rancoins - document.getElementById

('points').getAttribute("value"));
                            }
                            ...
                            if ('<%=ctrl1mainname%>' == "goldcoins") {
                                    if (myctrl1.tbResult == "giveonecrisboo") {
                                        ...
                                        document.getElementById('TextBox4').setAttribute("value", rancoins - 

    document.getElementById('points').getAttribute("value"));
...
('points').getAttribute("value"));
                    ...
                    if (ctrl2.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(ctrl2.style.left.replace("px", ""), 10) && 

parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(ctrl2.style.right.replace("px", ""), 10) || parseInt

(crosshair.style.top.replace("px", ""), 10) >= parseInt(ctrl2.style.top.replace("px", ""), 10) && parseInt

(crosshair.style.bottom.replace("px", ""), 10) <= parseInt(ctrl2.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
...
document.getElementById('points').getAttribute("value"));
    ...
    document.getElementById('points').getAttribute("value"));
                        ...
                        if (ctrl3.style.visibility == "visible") {
                            if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(ctrl3.style.left.replace("px", ""), 10) 

    && parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(ctrl3.style.right.replace("px", ""), 10) || parseInt

    (crosshair.style.top.replace("px", ""), 10) >= parseInt(ctrl3.style.top.replace("px", ""), 10) && parseInt

    (crosshair.style.bottom.replace("px", ""), 10) <= parseInt(ctrl3.style.bottom.replace("px", ""), 10)) {
                                enemyhits = enemyhits + 1;
                                if (enemyhits == 10) {
                                    enemyhits = 0;
                                    if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
                    ...
                    if (ctrl4.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(ctrl4.style.left.replace("px", ""), 10) && 

parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(ctrl4.style.right.replace("px", ""), 10) || parseInt

(crosshair.style.top.replace("px", ""), 10) >= parseInt(ctrl4.style.top.replace("px", ""), 10) && parseInt

(crosshair.style.bottom.replace("px", ""), 10) <= parseInt(ctrl4.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
                    ...
                    if (ctrl5.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(ctrl5.style.left.replace("px", ""), 10) && 

parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(ctrl5.style.right.replace("px", ""), 10) || parseInt

(crosshair.style.top.replace("px", ""), 10) >= parseInt(ctrl5.style.top.replace("px", ""), 10) && parseInt

(crosshair.style.bottom.replace("px", ""), 10) <= parseInt(ctrl5.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
                    ...
                    if (Img1.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(Img1.style.left.replace("px", ""), 10) && 

parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(Img1.style.right.replace("px", ""), 10) || parseInt

(crosshair.style.top.replace("px", ""), 10) >= parseInt(Img1.style.top.replace("px", ""), 10) && parseInt

(crosshair.style.bottom.replace("px", ""), 10) <= parseInt(Img1.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
    ...
    ('points').getAttribute("value"));
                    ...
                    if (Img2.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(Img2.style.left.replace("px", ""), 10) && 

    parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(Img2.style.right.replace("px", ""), 10) || parseInt

    (crosshair.style.top.replace("px", ""), 10) >= parseInt(Img2.style.top.replace("px", ""), 10) && parseInt

    (crosshair.style.bottom.replace("px", ""), 10) <= parseInt(Img2.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                    ...
                    if (Img3.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(Img3.style.left.replace("px", ""), 10) && 

    parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(Img3.style.right.replace("px", ""), 10) || parseInt

    (crosshair.style.top.replace("px", ""), 10) >= parseInt(Img3.style.top.replace("px", ""), 10) && parseInt

    (crosshair.style.bottom.replace("px", ""), 10) <= parseInt(Img3.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                    ...
                    if (Img4.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(Img4.style.left.replace("px", ""), 10) && 

    parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(Img4.style.right.replace("px", ""), 10) || parseInt

    (crosshair.style.top.replace("px", ""), 10) >= parseInt(Img4.style.top.replace("px", ""), 10) && parseInt

    (crosshair.style.bottom.replace("px", ""), 10) <= parseInt(Img4.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                    ...
                    if (Img5.style.visibility == "visible") {
                        if (parseInt(crosshair.style.left.replace("px", ""), 10) >= parseInt(Img5.style.left.replace("px", ""), 10) && 

    parseInt(crosshair.style.right.replace("px", ""), 10) <= parseInt(Img5.style.right.replace("px", ""), 10) || parseInt

    (crosshair.style.top.replace("px", ""), 10) >= parseInt(Img5.style.top.replace("px", ""), 10) && parseInt

    (crosshair.style.bottom.replace("px", ""), 10) <= parseInt(Img5.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                ...
                if (myctrl1.tbPropType == "fixed") {
                    if (ctrl1.style.visibility == "visible") {
                        if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(ctrl1.style.left.replace("px", ""), 10) && 

    parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(ctrl1.style.right.replace("px", ""), 10) || parseInt

    (explosion.style.top.replace("px", ""), 10) >= parseInt(ctrl1.style.top.replace("px", ""), 10) && parseInt

    (explosion.style.bottom.replace("px", ""), 10) <= parseInt(ctrl1.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
    ...
    ('points').getAttribute("value"));
                    ...
                    if (ctrl2.style.visibility == "visible") {
                        if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(ctrl2.style.left.replace("px", ""), 10) && 

    parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(ctrl2.style.right.replace("px", ""), 10) || parseInt

    (explosion.style.top.replace("px", ""), 10) >= parseInt(ctrl2.style.top.replace("px", ""), 10) && parseInt

    (explosion.style.bottom.replace("px", ""), 10) <= parseInt(ctrl2.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
    ...
    ('points').getAttribute("value"));
        ...
        ('points').getAttribute("value"));
                    ...
                    if (ctrl3.style.visibility == "visible") {
                        if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(ctrl3.style.left.replace("px", ""), 10) && 

    parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(ctrl3.style.right.replace("px", ""), 10) || parseInt

    (explosion.style.top.replace("px", ""), 10) >= parseInt(ctrl3.style.top.replace("px", ""), 10) && parseInt

    (explosion.style.bottom.replace("px", ""), 10) <= parseInt(ctrl3.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                        ...
                        if (ctrl4.style.visibility == "visible") {
                            if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(ctrl4.style.left.replace("px", ""), 10) && 

        parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(ctrl4.style.right.replace("px", ""), 10) || parseInt

        (explosion.style.top.replace("px", ""), 10) >= parseInt(ctrl4.style.top.replace("px", ""), 10) && parseInt

        (explosion.style.bottom.replace("px", ""), 10) <= parseInt(ctrl4.style.bottom.replace("px", ""), 10)) {
                                enemyhits = enemyhits + 1;
                                if (enemyhits == 10) {
                                    enemyhits = 0;
                                    if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                    ...
                    if (ctrl5.style.visibility == "visible") {
                        if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(ctrl5.style.left.replace("px", ""), 10) && 

    parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(ctrl5.style.right.replace("px", ""), 10) || parseInt

    (explosion.style.top.replace("px", ""), 10) >= parseInt(ctrl5.style.top.replace("px", ""), 10) && parseInt

    (explosion.style.bottom.replace("px", ""), 10) <= parseInt(ctrl5.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                    ...
                    if (Img1.style.visibility == "visible") {
                        if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(Img1.style.left.replace("px", ""), 10) && 

    parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(Img1.style.right.replace("px", ""), 10) || parseInt

    (explosion.style.top.replace("px", ""), 10) >= parseInt(Img1.style.top.replace("px", ""), 10) && parseInt

    (explosion.style.bottom.replace("px", ""), 10) <= parseInt(Img1.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
                    ...
                    if (Img2.style.visibility == "visible") {
                        if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(Img2.style.left.replace("px", ""), 10) 

    && parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(Img2.style.right.replace("px", ""), 10) || parseInt

    (explosion.style.top.replace("px", ""), 10) >= parseInt(Img2.style.top.replace("px", ""), 10) && parseInt

    (explosion.style.bottom.replace("px", ""), 10) <= parseInt(Img2.style.bottom.replace("px", ""), 10)) {
                            enemyhits = enemyhits + 1;
                            if (enemyhits == 10) {
                                enemyhits = 0;
                                if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
                ...
                if (Img3.style.visibility == "visible") {
                    if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(Img3.style.left.replace("px", ""), 10) && 

parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(Img3.style.right.replace("px", ""), 10) || parseInt

(explosion.style.top.replace("px", ""), 10) >= parseInt(Img3.style.top.replace("px", ""), 10) && parseInt

(explosion.style.bottom.replace("px", ""), 10) <= parseInt(Img3.style.bottom.replace("px", ""), 10)) {
                        enemyhits = enemyhits + 1;
                        if (enemyhits == 10) {
                            enemyhits = 0;
                            if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
                ...
                if (Img4.style.visibility == "visible") {
                    if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(Img4.style.left.replace("px", ""), 10) && 

parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(Img4.style.right.replace("px", ""), 10) || parseInt

(explosion.style.top.replace("px", ""), 10) >= parseInt(Img4.style.top.replace("px", ""), 10) && parseInt

(explosion.style.bottom.replace("px", ""), 10) <= parseInt(Img4.style.bottom.replace("px", ""), 10)) {
                        enemyhits = enemyhits + 1;
                        if (enemyhits == 10) {
                            enemyhits = 0;
                            if (mygoldcoins == null || mygoldcoins == 0) {
...
('points').getAttribute("value"));
                ...
                if (Img5.style.visibility == "visible") {
                    if (parseInt(explosion.style.left.replace("px", ""), 10) >= parseInt(Img5.style.left.replace("px", ""), 10) && 

parseInt(explosion.style.right.replace("px", ""), 10) <= parseInt(Img5.style.right.replace("px", ""), 10) || parseInt

(explosion.style.top.replace("px", ""), 10) >= parseInt(Img5.style.top.replace("px", ""), 10) && parseInt

(explosion.style.bottom.replace("px", ""), 10) <= parseInt(Img5.style.bottom.replace("px", ""), 10)) {
                        enemyhits = enemyhits + 1;
                        if (enemyhits == 10) {
                            enemyhits = 0;
                            if (mygoldcoins == null || mygoldcoins == 0) {
    ...
    ('points').getAttribute("value"));
        ...
        function moveCtrl() {
            ...
            if (playername != Session["friend1"]) {
                ...
                if (parseInt(ctrl1.style.top.replace("px", "")) > 130 + parseInt(myctrl1.tsctrl1res).toString().replace("px", "") 

&& parseInt(ctrl1.style.top.replace("px", "")) < 515) {
                ...
                if (parseInt(ctrl2.style.top.replace("px", "")) > 130 + parseInt(myctrl2.tsctrl2res).toString().replace("px", 

"") && parseInt(ctrl2.style.top.replace("px", "")) < 515) {
                ...
                if (parseInt(ctrl3.style.top.replace("px", "")) > 130 + parseInt(myctrl3.tsctrl3res).toString().replace("px", 

"") && parseInt(ctrl3.style.top.replace("px", "")) < 515) {
                ...
                if (parseInt(ctrl4.style.top.replace("px", "")) > 130 + parseInt(myctrl4.tsctrl4res).toString().replace("px", 

"") && parseInt(ctrl4.style.top.replace("px", "")) < 515) {
                ...
                if (parseInt(ctrl5.style.top.replace("px", "")) > 130 + parseInt(myctrl5.tsctrl5res).toString().replace("px", 

"") && parseInt(ctrl5.style.top.replace("px", "")) < 515) {
        ...
        function moveprop(e) {
            ...
            if (Math.round(e.clientX) > 365 && Math.round(e.clientY) > 130 && Math.round(e.clientX) < 375 && 

Math.round(e.clientY) < 875) {
                document.body.style.cursor = "none";
            }

            else if (Math.round(e.clientX) > 0 && Math.round(e.clientY) > 0 && Math.round(e.clientX) < 365 && 

Math.round(e.clientY) < 130) {
                document.body.style.cursor = "none";
            }
            ...
            else if (parseInt(currentlposition.replace("px", ""), 10) < Math.round(e.clientY) && parseInt

(currentlposition.replace("px", ""), 10) < Math.round(e.clientX)) {
                positionresult = "jump";
            }
            else if (parseInt(currentlposition.replace("px", ""), 10) > Math.round(e.clientY) && parseInt
...
Transparent; width: 96%; height: 43%; top: 2%; left: 1%; z-index: 1001; position: absolute;" />
            <asp:Label ID="Label22" runat="server" Style="z-index: 1001; left: 3%; top: 70%; position: absolute; vertical-align: middle; text-align: center; width: 62%; height: 7%"
                ForeColor="White" Font-Bold="True" Font-
                Size="100%" Font-Names="Haettenschweiler">Congratulations You Have Conquered this Treasure Spot. Keep 

Playing. </asp:Label>
        </div>
        <div style="width: 49%; height: 66%; z-index: 1000; left: 38%; top: 23%; visibility: hidden; position: absolute; background-color: #FFFF66; overflow: hidden;"
            id="showlevels">
            <button id="Button12" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 22%; height: 7%; background-color: #FF00FF; color: #FFFFFF; top: 89%; left: 69%;">
                Back to Game
            </button>
            <asp:TextBox ID="TextBox18" runat="server" BackColor="Transparent" BorderStyle="Solid"
                ClientIDMode="Static" Style="z-index: 1001; left: 2%; top: 3%; position: absolute; width: 101%; height: 43%;"
                ForeColor="#660066" meta:resourcekey="pointsResource1" ReadOnly="true" Font-Size="80%"
                TextMode="MultiLine">Level           Conqueor    Own TreasureSpots (min)
1-30                   3                       0
31-75                  5                       1
76-130                 5                       10
131-200                6                       50
...
400-1000               8                       100</asp:TextBox>
        ...
        <div style="width: 49%; height: 67%; z-index: 1000; left: 38%; top: 22%; visibility: hidden; position: absolute; background-color: #669999;"
            id="showprof">
            <img alt="" src="Images/goldcoin.gif" style="z-index: 1101; left: 80%; top: 32%; position: absolute; height: 9%; width: 8%;" />
            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="100%" ForeColor="White" Style="z-

index: 1001; left: 3%; top: 5%; position: absolute; width: 96%; height: 15%;"
                Text="Professional Help to Complete 

Your TreasureSpot or Game Tools"></asp:Label>
            <asp:Label ID="Label5" runat="server" Style="z-index: 1001; left: 15%; top: 15%; position: absolute; vertical-

align: middle; text-align: center; width: 77%; height: 12%;"
                Text="A Professional will complete your TreasureSpot or 

Game Tools on behalf of you"
                ForeColor="White" Font-Size="100%"></asp:Label>
            <asp:Label ID="Label6" runat="server" Style="z-index: 1001; left: 4%; top: 40%; position: absolute; vertical-

align: middle; text-align: center; width: 15%; height: 6%;"
                Text="Price   $1" ForeColor="White" Font-Bold="True"
                Font-Size="100%"></asp:Label>
            <asp:HyperLink ID="Hyperlink8" runat="server" Font-Underline="False"
                NavigateUrl="http://astore.amazon.com/treasurehun05-20" Style="z-index: 1001; border-radius: 2%; background-

color: #0000FF; top: 40%; position: absolute; height: 6%; width: 34%; left: 23%; text-align: center; vertical-align: middle;"
                Target="_self" ForeColor="#FFCC00" meta:resourcekey="Hyperlink1Resource1"
                ViewStateMode="Enabled" Font-Size="100%">Buy Professional Help</asp:HyperLink>
            <button id="Button4" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 24%; height: 8%; background-color: #FF00FF; color: #FFFFFF; top: 80%; left: 60%; font-size: 100%;">
                Back to Game
            </button>
        </div>
        <div style="width: 49%; height: 66%; z-index: 1000; left: 38%; top: 24%; visibility: hidden; position: absolute; background-color: #9900FF"
            id="showspot">
            <img alt="" src="Images/coin.png" style="z-index: 1001; left: 5%; top: 5%; position: absolute; width: 9%; height: 12%;" />
            <asp:Label ID="Label7" runat="server" Font-Bold="True" Font-Size="100%" ForeColor="White" Style="z-

index: 1001; left: 19%; top: 8%; width: 47%; height: 7%; position: absolute"
                Text="Buy a Treasure 

Spot"></asp:Label>
            <asp:Label ID="Label8" runat="server" Style="z-index: 1001; left: 18%; top: 18%; position: absolute; vertical-align: middle; text-align: center; width: 73%; height: 15%;"
                Text="You Have Played Now in a TreasureSpot. 

Create your own TreasureSpot to Earn More Rewards. "
                ForeColor="White" Font-Size="100%"></asp:Label>
            <asp:Label ID="Label9" runat="server" Style="z-index: 1001; left: 4%; top: 37%; position: absolute; vertical-

align: middle; text-align: center; width: 18%; height: 10%;"
...
color: #0000FF; top: 37%; position: absolute; height: 7%; width: 64%; left: 23%; text-align: center; vertical-align: middle;"
                Target="_self" ForeColor="#FFCC00" meta:resourcekey="Hyperlink1Resource1"
                ViewStateMode="Enabled" Font-Size="100%">Buy a Treasure Spot(Offer Claims Enabled)</asp:HyperLink>
            <button id="Button5" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 23%; height: 7%; background-color: #FF00FF; color: #FFFFFF; top: 88%; left: 64%; font-size: 100%;"
                onclick="hidediv();">
                Back to Game
            </button>
...
decoration: none;"
                Target="_blank" ForeColor="White" BackColor="#FF9900"
                ImageUrl="https://www.paypalobjects.com/en_GB/i/btn/btn_buynowCC_LG.gif"></asp:HyperLink>
            <asp:Label ID="Label24" runat="server" Style="z-index: 1001; left: 58%; top: 68%; position: absolute; vertical-align: middle; text-align: center; width: 39%; height: 13%;"
                Text="(PayPal Offer Claims Not Enabled)"
                ForeColor="White" Font-Bold="True" Font-Size="100%"></asp:Label>

        </div>
        <div style="width: 50%; height: 66%; z-index: 1000; left: 38%; top: 24%; visibility: hidden; position: absolute; background-color: #666633"
            id="showpromo">
            <img alt="" src="Images/lwinner.jpg" style="z-index: 1101; left: 3%; top: 6%; position: absolute; height: 15%; width: 15%;" />
            <asp:Label ID="Label10" runat="server" Font-Bold="True" Font-Size="100%" ForeColor="White" Style="z-

index: 1001; left: 22%; top: 7%; position: absolute; width: 55%; height: 15%;"
                Text="Wow you just won a 

TreasureSpot at a Concessional Price"></asp:Label>
            <asp:Label ID="Label11" runat="server" Style="z-index: 1001; left: 16%; top: 30%; position: absolute; vertical-align: middle; text-align: center; width: 78%; height: 15%;"
                Text="You were the randomly selected winner of 

a TreasureSpot"
                ForeColor="White" Font-Size="100%"></asp:Label>
            <asp:HyperLink ID="Hyperlink9" runat="server" Font-Underline="False" NavigateUrl=" 

http://www.amazon.com/?tag=treasurehun05-20"
                Style="z-index: 1001; border-radius: 2%; background-color: #0000FF; top: 69%; position: absolute; height: 8%; width: 37%; left: 4%; text-align: center; vertical-align: middle;"
                Target="_self" ForeColor="#FFCC00" meta:resourcekey="Hyperlink1Resource1" ViewStateMode="Enabled" Font-
                Size="100%">Claim My Treasurespot</asp:HyperLink>
            <button id="Button6" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 22%; height: 7%; background-color: #FF00FF; color: #FFFFFF; top: 68%; left: 63%; font-size: 100%;">
                Back to Game
            </button>
        </div>
        <div style="width: 50%; height: 67%; z-index: 1000; left: 38%; top: 23%; visibility: hidden; position: absolute; background-color: #FF6666"
            id="showlife">
            <img alt="" src="Images/health.gif" style="z-index: 1101; left: 2%; top: 5%; position: absolute; height: 13%; width: 12%;" />
            <asp:Label ID="Label12" runat="server" Font-Bold="True" Font-Size="15pt" ForeColor="White" Style="z-

index: 1001; left: 76px; top: 32px; position: absolute; width: 349px;"
                Text="Additional Lifes During Your Game 

Play"></asp:Label>
            <asp:Label ID="Label13" runat="server" Style="z-index: 1001; left: 30px; top: 86px; position: absolute; vertical-align: middle; text-align: center; width: 394px; margin-top: 0px; bottom: 176px;"
                Text="Get 20 More Lifes 

During Game Playing. Buy to Clear the Level."
                ForeColor="White"></asp:Label>
            <asp:Label ID="Label14" runat="server" Style="z-index: 1001; left: 18px; top: 162px; position: absolute; vertical-align: middle; text-align: center; width: 72px; margin-top: 0px;"
            ...
            <button id="Button7" style="z-index: 1001; border-radius: 10px; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 162px; height: 39px; background-color: #FF00FF; color: #FFFFFF; top: 234px; left: 234px;"
                onclick="actionthgame();">
                Back to Game
            </button>
        </div>
        <div style="width: 49%; height: 67%; z-index: 1000; left: 38%; top: 23%; visibility: hidden; position: absolute; background-color: #FF5050"
            id="showtweet">
            <img alt="" src="Images/landscape.jpg" style="z-index: 1101; left: 3%; top: 4%; position: absolute; height: 20%; width: 22%" />
            <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="100%" ForeColor="White" Style="z-

index: 1001; left: 37%; top: 8%; position: absolute; width: 41%; height: 7%;"
                Text="Tweet on Twitter"></asp:Label>
            <asp:Label ID="Label16" runat="server" Style="z-index: 1001; left: 35%; top: 20%; position: absolute; vertical-align: middle; text-align: center; width: 59%; height: 15%;"
                Text="To Make TreasureHunting more 

interesting tweet on Twitter and Expres Yourself"
                ForeColor="White" Font-Size="100%"></asp:Label>
            <button id="Button8" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 23%; height: 8%; background-color: #FF00FF; color: #FFFFFF; top: 84%; left: 68%; font-size: 100%;"
                onclick="actionrewards();">
                Back to Game
            </button>
            <a href="https://twitter.com/share" class="twitter-share-button" data-lang="en" style="z-index: 1001; text-

decoration: none; position: absolute; top: 84%; left: 5%; width: 41%; height: 10%;">Tweet</a>
        </div>
        <div style="width: 50%; height: 67%; z-index: 1000; left: 38%; top: 22%; visibility: hidden; position: absolute; background-color: #3333FF"
            id="showtools">
            <img alt="" src="Images/goldcoin.gif" style="z-index: 1101; left: 7%; top: 6%; position: absolute; height: 15%; width: 15%;" />
            <asp:Label ID="Label17" runat="server" Font-Bold="True" Font-Size="100%" ForeColor="White" Style="z-

index: 1001; left: 25%; top: 11%; position: absolute; height: 6%; width: 46%;"
                Text="Buy a Game Tools 

Item"></asp:Label>
            <asp:Label ID="Label18" runat="server" Font-Size="100%" Style="z-index: 1001; left: 23%; top: 22%; position: absolute; vertical-align: middle; text-align: center; width: 62%; height: 15%;"
                Text="Add your own choice of 

Game Items to your TreasureSpot."
                ForeColor="White"></asp:Label>
            <asp:Label ID="Label19" runat="server" Font-Size="100%" Style="z-index: 1001; left: 17%; top: 42%; position: absolute; vertical-align: middle; text-align: center; width: 17%; height: 8%;"
                Text="Price   $1"
...
color: #0000FF; top: 54%; position: absolute; height: 8%; width: 45%; left: 4%; text-align: center; vertical-align: middle;"
                Target="_self" ForeColor="#FFCC00" meta:resourcekey="Hyperlink1Resource1"
                ViewStateMode="Enabled">Buy Game Items for TreasureSpot</asp:HyperLink>
            <button id="Button9" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 26%; height: 10%; background-color: #FF00FF; color: #FFFFFF; top: 55%; left: 57%; font-size: 100%;">
                Back to Game
            </button>
        </div>
        <div style="width: 50%; height: 67%; z-index: 1000; left: 38%; top: 23%; visibility: hidden; position: absolute; background-color: #FF5050"
            id="showfriends">
            <img alt="" src="Images/landscape.jpg" style="z-index: 1101; left: 7%; top: 6%; position: absolute; height: 15%; width: 15%" />
            <asp:Label ID="Label20" runat="server" Font-Bold="True" Font-Size="100%" ForeColor="White" Style="z-

index: 1001; left: 37%; top: 9%; height: 9%; width: 26%; position: absolute"
                Text="Invite Friends"></asp:Label>
            <asp:Label ID="Label21" runat="server" Style="z-index: 1001; left: 24%; top: 18%; position: absolute; vertical-align: middle; text-align: center; width: 65%; height: 15%;"
                Text="To Make TreasureHunting more 

interesting invite your Friends and Like the Game"
                ForeColor="White" Font-Size="100%"></asp:Label>
            <button id="Button10" style="z-index: 1001; border-radius: 2%; text-align: center; vertical-align: middle; border: medium outset #FFFF00; position: absolute; width: 24%; height: 8%; background-color: #FF00FF; color: #FFFFFF; top: 66%; left: 61%; font-size: 100%;"
                onclick="ifriends();">
                Back to Game
            </button>
        ...
        <asp:Button ID="Button3" runat="server" BackColor="Transparent" BorderColor="#CCCCFF"
            BorderStyle="Solid" Font-Size="60%" ForeColor="White" Style="z-index: 1; left: 88%; top: 74%; cursor: pointer; position: absolute; width: 10%; height: 5%;"
            Text="Rate Good to this TreasureSpot" OnClick="Button3_Click"
...
@luposition, @luimg, @luspriteimg, @lucrisboos, @luloggedin, @lutspots, @lulogintimes, @luinvites)"
        ...
        <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT * FROM [tspots]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT * FROM [toolbox]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT [treasurevalue] FROM [treasureprize]"></asp:SqlDataSource>
...
@luposition, @luimg, @luspriteimg, @lucrisboos, @luloggedin, @lutspots, @lulogintimes, @luinvites)"
        ...
        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT * FROM ordercounter" InsertCommand="INSERT INTO ordercounter(uname, 

ccounter) Values (@uname, @ccounter)"
            UpdateCommand="UPDATE ordercounter SET @uname=''">
            <InsertParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:c9ddedcf-4582-4aa0-b614-a4710054b560ConnectionString %>" SelectCommand="SELECT * FROM winners" InsertCommand="INSERT INTO winners(uname, crisboos) Values 

(@uname, @crisboos)"
            UpdateCommand="UPDATE winners SET @uname=''">
            <InsertParameters>
                <asp:Parameter Name="uname" />
...
index: 1; left: 16%; top: 1%; position: absolute; width: 43%; height: 4%;"
            Text="Label"
            meta:resourcekey="Label1Resource1"></asp:Label>
        <asp:Label ID="Label2" runat="server" Font-Bold="False" Font-Size="90%" ForeColor="#9999FF" Style="z-

index: 1; left: 40%; top: 17%; position: absolute; width: 36%; height: 3%;"
            Text="Use Mouse or arrow keys for 

movement, click or 's' for functions"
        ...
        <div id="divplayer" onmouseover="moveprop(event)" onmousedown="explodeprop(event)" onkeydown="check(e)" style="border-style: outset; border-width: thin; z-index: 203; background-color: transparent; width: 49%; height: 66%; position: absolute; top: 25%; left: 37%;">
            ...
            <%--<img id="player1" src="" style="width: 30px; height: 30px; position: absolute; top: 278px; left: 229px; 

z-index: 21; right: 460px; margin-left: 0px; margin-top: 0px;">
        <img id="player2" src="" style="width: 30px; height: 30px; position: absolute; top: 296px; left: 260px; z-index: 

21; right: 562px; margin-left: 0px; margin-top: 0px;">
        <img id="player3" src="" style="width: 30px; height: 30px; position: absolute; top: 78px; left: 229px; z-index: 

21; right: 460px; margin-left: 0px; margin-top: 0px;">
        <img id="player4" src="" style="width: 30px; height: 30px; position: absolute; top: 302px; left: 245px; z-index: 

21; right: 577px; margin-left: 0px; margin-top: 0px;">
        <img id="player5" src="" style="width: 30px; height: 30px; position: absolute; top: 251px; left: 390px; z-index: 

21; right: 299px; margin-left: 0px; margin-top: 0px;">
            --%>
        ...
        <asp:TextBox ID="TextBox7" runat="server" BackColor="#FFFF99" BorderStyle="None"
            ClientIDMode="Static" ReadOnly="True" Style="z-index: 700; left: 1%; top: 45%; position: absolute; width: 96%; height: 15%; vertical-align: middle; border: 15px ridge #99FF99;"
            ForeColor="#0000CC"
            meta:resourcekey="livesResource1" ViewStateMode="Enabled" Font-Bold="True" Font-Names="Kootenay" Font-
            Size="70%"></asp:TextBox>
        <asp:TextBox ID="points" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 49%; top: 6%; position: absolute; width: 10%; height: 4%;"
            ForeColor="#FFCC00" ReadOnly="false" Font-Size="100%">0</asp:TextBox>
        <asp:TextBox ID="treasure" runat="server" AutoPostBack="False" BackColor="Transparent"
            BorderStyle="None" ClientIDMode="Static" ReadOnly="True" Style="z-index: 1; left: 90%; top: 62%; position: absolute; width: 9%; height: 4%; text-align: center; vertical-align: middle;"
            ForeColor="#FFCC00"
            meta:resourcekey="treasureResource1" ViewStateMode="Enabled" Font-Size="90%"></asp:TextBox>
        <asp:Label ID="Label3" runat="server" ForeColor="#FFCC00" Font-Size="100%" Style="z-index: 1; left: 56%; top: 43%; position: absolute; width: 11%; height: 4%; text-align: center; vertical-align: middle;"
            Text="Loading ......."
        ...
        <label style="position: absolute; top: 1%; left: 1%; height: 4%; color: #FFCC00; font-family: 'Jokerman LET'; font-size: 100%; font-weight: lighter;">
            Achievements
        </label>

        <label style="position: absolute; top: 33px; left: 22%; height: 4%; color: #FFCC00; font-family: 'Jokerman LET'; font-size: 100%; width: 53px;">
            Lives
        </label>

        <label style="position: absolute; top: 33px; left: 39%; height: 4%; color: #FFCC00; position: absolute; font-

family: 'Jokerman LET'; font-size: 100%; width: 9%;">
            Gold Coins
        </label>

        <label style="left: 91%; top: 54%; position: absolute; width: 6%; height: 4%; text-align: center; vertical-

align: middle; color: #FFCC00; font-family: 'Jokerman LET'; font-size: 70%;">
            Treasure( $)
        </label>
        <label style="position: absolute; top: 17%; left: 1%; height: 4%; color: #FFCC00; width: 10%; font-family: 'Victorian LET'; font-size: 100%;">
            Players
        </label>
        ...
        <input id="Button2" style="border: medium outset #FF00FF; background-color: #6699FF; color: #FFFFFF; z-
...
index: 1; position: absolute; left: 30%; top: 90%; width: 5%; height: 4%; border-radius: 20%;"
        ...
        <input id="Text1" type="text" style="border: medium ridge #00CC00; position: absolute; left: 1%; top: 90%; width: 25%; height: 4%; background-color: #FFFFCC; color: #000000; right: 939px;"
...
(event);" />
        <div id="aimg" style="position: absolute; left: 11%; top: 18%; width: 25%; height: 34%;">
            ...
            <img id="Image1" style="z-index: 300; left: 82px; top: 101px; position: absolute; width: 36px; height: 39px;"
                src='<%=one1%>' />
            <img id="Image2" style="z-index: 300; left: 112px; top: 60px; position: absolute; width: 32px; height: 30px;"
                src='<%=one2%>' />
            <img id="Image3" style="z-index: 300; left: 159px; top: 30px; position: absolute; width: 34px; height: 32px;"
                src='<%=one3%>' />
            <img id="Image4" style="z-index: 300; left: 35px; top: 149px; position: absolute; width: 39px; height: 35px;"
                src='<%=one4%>' />
            <img id="Image5" style="z-index: 300; left: 203px; top: 10px; position: absolute; width: 26px; height: 33px;"
                src='<%=one5%>' />
        ...
        <div id="tooltip" style="position: absolute; top: 218px; left: 494px; width: 107px; height: 104px; visibility: hidden;">
            ...
            <img id="playerpic" style="position: absolute; background-color: transparent; top: 75px; left: 7px; height: 18px; width: 90px; font-size: 8px;"
                src='<%=Session["friend1pic"]%>' />
        </div>
        <label style="z-index: 1000; position: absolute; top: 20%; left: 12%; height: 5%; color: #FFCC00; position: absolute; font-size: 100%; width: 12%; font-family: 'John Handy LET';">
            Treasure Map
        </label>
        <asp:TextBox ID="attacked" runat="server" Font-Size="90%" BackColor="Transparent" BorderStyle="None"
...
align: center; vertical-align: middle;"
            ...
            ReadOnly="false">120</asp:TextBox>
        <asp:TextBox ID="TextBox3" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 1%; top: 55%; position: absolute; width: 11%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="Victorian LET" Font-Size="70%">Collect Coins</asp:TextBox>
        <asp:TextBox ID="TextBox4" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 14%; top: 55%; position: absolute; width: 13%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Size="70%"></asp:TextBox>
        <asp:TextBox ID="TextBox5" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 1%; top: 60%; position: absolute; width: 10%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="Victorian LET" Font-Size="70%">Conquer Players</asp:TextBox>
        <asp:TextBox ID="TextBox6" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 12%; top: 59%; position: absolute; width: 12%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Size="70%"></asp:TextBox>
        <asp:TextBox ID="TextBox8" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 87%; top: 93%; position: absolute; width: 6%; height: 3%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="News Gothic" Font-Size="70%">Rating</asp:TextBox>
        <asp:TextBox ID="TextBox9" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 94%; top: 92%; position: absolute; width: 6%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="OldDreadfulNo7 BT" Font-Size="80%"></asp:TextBox>
        <asp:TextBox ID="TextBox10" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 87%; top: 17%; position: absolute; width: 13%; height: 3%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="News Gothic" Font-Size="80%">Treasure Spots Owned</asp:TextBox>
        <asp:TextBox ID="TextBox11" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 91%; top: 25%; position: absolute; width: 6%; height: 3%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="News Gothic" Font-Size="80%">Level</asp:TextBox>
        <asp:TextBox ID="TextBox12" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 91%; top: 29%; position: absolute; width: 6%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Text='<%=levels%>' Font-Size="80%"></asp:TextBox>
        <asp:TextBox ID="TextBox13" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 91%; top: 21%; position: absolute; width: 6%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Size="80%" Text="0"></asp:TextBox>
        <asp:TextBox ID="TextBox14" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 87%; top: 35%; position: absolute; width: 13%; height: 3%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="News Gothic" Font-Size="80%">Treasure Spots Collected</asp:TextBox>
        <asp:TextBox ID="TextBox15" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 90%; top: 44%; position: absolute; width: 9%; height: 3%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Names="News Gothic" Font-Size="80%">Coins Collected</asp:TextBox>
        <asp:TextBox ID="TextBox16" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 91%; top: 39%; position: absolute; width: 6%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Size="80%" Text='<%=tspotscollected%>'></asp:TextBox>
        <asp:TextBox ID="TextBox17" runat="server" BackColor="Transparent" BorderStyle="None"
            ClientIDMode="Static" Style="z-index: 1; left: 89%; top: 48%; position: absolute; width: 11%; height: 4%; text-

align: center; vertical-align: middle;"
            ForeColor="#FFCC00" meta:resourcekey="pointsResource1" ReadOnly="false"
            Font-Size="80%" Text="0" ToolTip="If in Red Color not Eligible for Prizes and Collected coins in every TreasureSpot 
